  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": {
            boxShadow: "0 0 20px hsl(var(--valentine-pink) / 0.5), 0 0 40px hsl(var(--valentine-pink) / 0.3)",
            transform: "scale(1)"
          },
          "50%": {
            boxShadow: "0 0 30px hsl(var(--valentine-pink) / 0.7), 0 0 60px hsl(var(--valentine-pink) / 0.5)",
      ...
      animation: {
        ...
        "float-heart": "float-heart 8s linear infinite",
        "pulse-glow": "pulse-glow 2s ease-in-out infinite",
        "celebration-bounce": "celebration-bounce 0.6s ease-in-out infinite"
      }
    }
  },
